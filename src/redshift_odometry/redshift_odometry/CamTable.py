class CamTable():
    ...
    # 
    #
    # this table has the quat transform from center of robot to camera AFTER rotating it to RDF (Right-Down-Front)
    # I do rotation in any axis order and then use the above calculator to convert to quaternion.
    # IMPORTANT: if there is no additional rotation, set the quaternion to qx,qy,qz,qw of 0,0,0,1
    # 
    # Examples:
    #    "qx": 0.3826834, "qy": 0, "qz": 0, "qw": 0.9238795   # tilt 45 degrees up 
    #    "qx": 0, "qy": -0.3826834, "qz": 0, "qw": 0.9238795  #tilt 45 degrees left 
    ...
    cam_table_temp = [
      {"camid": "cam1" , "x": 0.3015, "y": -0.251, "z": 0.18, "qx": 0, "qy": -0.0871557, "qz": 0, "qw": 0.9961947},  # old reef camera 10 left
